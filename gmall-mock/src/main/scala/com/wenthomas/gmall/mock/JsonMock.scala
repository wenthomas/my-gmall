package com.wenthomas.gmall.mock

import java.util.Date

import com.alibaba.fastjson.{JSON, JSONObject}
import com.wenthomas.gmall.mock.util.{LogUploader, RandomNumUtil, RandomOptions}
/**
 * @author Verno
